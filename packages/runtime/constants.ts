...
export const CONTRIBUTION_RELAY_ENDPOINT =
  process.env.SELFTUNE_CONTRIBUTION_RELAY_ENDPOINT?.trim() ??
  "https://cloud.selftune.dev/api/v1/contributions/relay";
...
export const CONTRIBUTION_PUBLIC_RELAY_ENDPOINT =
  process.env.SELFTUNE_CONTRIBUTION_PUBLIC_RELAY_ENDPOINT?.trim() ?? "";
