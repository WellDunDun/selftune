...
import {
  SELFTUNE_SCHEDULE_JOBS,
  type ScheduleJobDefinition,
} from "@selftune/runtime/schedule-definitions";

// ---------------------------------------------------------------------------
// Types & constants
// ---------------------------------------------------------------------------

export type CronJobConfig = ScheduleJobDefinition;

export const DEFAULT_CRON_JOBS: CronJobConfig[] = SELFTUNE_SCHEDULE_JOBS.map((job) => ({
  ...job,
}));
