  ...
  return (
    <>
      <motion.button
        ...
        className={cn(
          "relative inline-flex h-9 select-none items-center justify-center rounded-[9px] border border-border bg-background px-3.5 text-[13px] font-medium text-foreground shadow-sm outline-none transition-[border-color,box-shadow,background-color] duration-150 hover:bg-accent focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:opacity-50",
          className,
        )}
