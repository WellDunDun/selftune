...
>()("@selftune/source-management/SourceSync") {}

/**
 * Imperative application-edge adapter for source synchronization.
 *
 * SourceSync itself stays in Effect so callers can compose it with their
 * resource scope. CLI and desktop entrypoints use this Promise boundary.
 */
export type SourceSyncRunner = (request?: SourceSyncRequest) => Promise<SyncResult>;
