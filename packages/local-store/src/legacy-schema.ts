/**
 * Pre-Drizzle SQLite compatibility schema.
 *
 * This file only upgrades databases created by older SelfTune releases before
 * they are stamped at the Drizzle baseline. New schema changes belong in
 * `drizzle-schema.ts` and a generated migration, not in this file.
 */
